...
from database.schemas import ScoringTrackBase, ScoringTrackCreate, ScoringTrackResponse, ScoringTrackUpdate
...
# Get all scoring tracks with optional filtering
...
async def create_scoring_tracks_batch(
    ...
    try:
        ...
        for track in tracks:
            # Create point geometry
            point_geom = ST_MakePoint(track.lon, track.lat)
        ...
        return {"message": f"Successfully created {len(db_tracks)} scoring tracks"}
